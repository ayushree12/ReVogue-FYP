...
const AuthLayout = ({ title, description, highlightList = [], footerCallout, children }) => (
  <div className="mx-auto w-full max-w-5xl space-y-10">
    <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
      <div className="rounded-[2rem] bg-gradient-to-br from-slate-900 via-gray-900 to-black p-8 text-white shadow-[0_20px_80px_rgba(15,23,42,0.45)]">
        <p className="text-xs uppercase tracking-[0.4em] text-slate-400">Revogue access</p>
